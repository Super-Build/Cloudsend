...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the CloudSend network..."),
        ...
        ("install_tip", "Due to UAC, CloudSend can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install CloudSend to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant CloudSend \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant CloudSend \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow CloudSend to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [CloudSend Input] service."),
        ...
        ("android_stop_service_tip", "Stopping screen sharing keeps the core connection service online, so PC voice calls and connections can continue."),
        ...
        ("android_start_service_tip", "The core connection service stays online while the app is running. Tap [Start service] only to request screen sharing and start sending video."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next CloudSend application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant CloudSend \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant CloudSend \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running CloudSend."),
        ...
        ("verify_cloudsend_password_tip", "Verify CloudSend password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use CloudSend and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade CloudSend Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent CloudSend from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by CloudSend"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if CloudSend window is open"),
        ...
        ("floating_window_tip", "It helps to keep CloudSend background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the CloudSend client to version {} or newer on the remote side!"),
