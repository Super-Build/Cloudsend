...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Show CloudSend status monitor", "显示 CloudSend 状态监测"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于 UAC 限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮将 CloudSend 安装到系统，从而规避上述问题。"),
        ("Click to upgrade", "点击这里升级"),
        ("Click to download", "点击这里下载"),
        ("Click to update", "点击这里更新"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予 CloudSend \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予 CloudSend \"开始输入\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("android_stop_service_tip", "停止屏幕共享不会关闭核心连接服务，PC 仍可保持连接并进行语音通话。"),
        ("android_version_audio_tip", "当前安卓版本不支持音频录制，请升级至安卓 10 或更高。"),
        ("android_start_service_tip", "应用运行后核心连接服务会自动保持在线；点击启动服务仅用于申请屏幕共享权限并开始传输画面。"),
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep CloudSend background service", "保持 CloudSend 后台服务"),
        ("Ignore Battery Optimizations", "忽略电池优化"),
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的 CloudSend 应用设置页面中，找到并进入 [电源] 页面，取消勾选 [不受限制]"),
        ("Start on boot", "开机自启动"),
        ...
        ("config_input", "为了能够通过键盘控制远程桌面, 请给予 CloudSend \"输入监控\" 权限。"),
        ("config_microphone", "为了支持通过麦克风进行音频传输，请给予 CloudSend \"录音\"权限。"),
        ...
        ("still_click_uac_tip", "依然需要被控端用户在运行 CloudSend 的 UAC 窗口点击确认。"),
        ...
        ("verify_cloudsend_password_tip", "验证 CloudSend 密码"),
        ...
        ("{} sessions", "{} 个会话"),
        ("scam_title", "你可能被骗了！"),
        ("scam_text1", "如果你正在和素不相识的人通话，而对方要求你使用 CloudSend 启动服务，请勿继续操作并立刻挂断电话。"),
        ...
        ("selinux_tip", "SELinux 处于启用状态，CloudSend 可能无法作为被控正常运行。"),
        ("Change view", "更改视图"),
        ("Big tiles", "大磁贴"),
        ("Small tiles", "小磁贴"),
        ("List", "列表"),
        ...
        ("powered_by_me", "由 CloudSend 提供支持"),
        ...
        ("allow-only-conn-window-open-tip", "仅当 CloudSend 窗口打开时允许连接"),
        ...
        ("View camera", "查看摄像头"),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "请在远程端将 CloudSend 客户端升级至版本 {} 或更新版本！"),
